...
# amplitudes
amp_f1_sin = (2 * dot_f1_sin) / (PERIOD_VECTOR_SIZE * 1)
amp_f1_cos = (2 * dot_f1_cos) / (PERIOD_VECTOR_SIZE * 1) 

amp_f2_sin = (2 * dot_f2_sin) / (PERIOD_VECTOR_SIZE * 1)
amp_f2_cos = (2 * dot_f2_cos) / (PERIOD_VECTOR_SIZE * 1)
